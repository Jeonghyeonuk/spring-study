...
//        RestTemplate rest = new RestTemplate(); // 서버에서 서버로 요청할때 사용한다
//        HttpHeaders headers = new HttpHeaders();
//        headers.add("X-Naver-Client-Id", "zdqMoIkFaK8uKvC2oNY2"); //네이버 openApi 요청
...
//        ObjectMapper objectMapper = new ObjectMapper() // 네이버에서 받은 응답JSON형태를 가지고 자바객체형태로 변환시키는것.
